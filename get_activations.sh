...
d=NiN_batch256_stepsize50k_maxiter110k_fromCompiler_withDropout_fixWeightInit/
weights=$d/nin_imagenet_train_iter_110000.caffemodel
#weights=$d/alexnet_finetune_iter_20000.caffemodel #TODO: pick newest one.
#iter=35 # number of batches (1750/50)
