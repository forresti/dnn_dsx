...
def get_barebones_net():
    ...
    barebones_net['conv1'] = {'type': "Convolution", 'convolution_param':{'num_output':96, 'kernel_size':11, 'stride':1, 'weight_filler':{'std':0.01}}} 
...
#conv2 - cccp4
    barebones_net['conv2'] = {'type': "Convolution", 'convolution_param':{'num_output':256, 'kernel_size':5, 'stride':2, 'pad':2, 'weight_filler':{'std':0.05}}}
    barebones_net['relu_conv2'] = {'type': "ReLU"}

    barebones_net['cccp3'] = {'type': "Convolution", 'convolution_param':{'num_output':256, 'kernel_size':1, 'stride':1, 'weight_filler':{'std':0.05}}}
    barebones_net['relu_cccp3'] = {'type': "ReLU"}

    barebones_net['cccp4'] = {'type': "Convolution", 'convolution_param':{'num_output':256, 'kernel_size':1, 'stride':1, 'weight_filler':{'std':0.05}}}
    barebones_net['relu_cccp4'] = {'type': "ReLU"}

    barebones_net['pool2'] = {'type': "Pooling"} #assume defaults: MAX, ksize=3, stride=2

#conv3 - cccp6
    barebones_net['conv3'] = {'type': "Convolution", 'convolution_param':{'num_output':384, 'kernel_size':3, 'stride':2, 'pad':1, 'weight_filler':{'std':0.01}}}
    barebones_net['relu_conv3'] = {'type': "ReLU"}

    barebones_net['cccp5'] = {'type': "Convolution", 'convolution_param':{'num_output':384, 'kernel_size':1, 'stride':1, 'weight_filler':{'std':0.05}}}
    barebones_net['relu_cccp5'] = {'type': "ReLU"}

    barebones_net['cccp6'] = {'type': "Convolution", 'convolution_param':{'num_output':384, 'kernel_size':1, 'stride':1, 'weight_filler':{'std':0.05}}}
...
#conv4 - cccp8
    barebones_net['conv4'] = {'type': "Convolution", 'convolution_param':{'num_output':1024, 'kernel_size':3, 'stride':1, 'pad':1, 'weight_filler':{'std':0.05}}}
    barebones_net['relu_conv4'] = {'type': "ReLU"}

    barebones_net['cccp7'] = {'type': "Convolution", 'convolution_param':{'num_output':1024, 'kernel_size':1, 'stride':1, 'weight_filler':{'std':0.05}}}
    barebones_net['relu_cccp7'] = {'type': "ReLU"}

    barebones_net['cccp8'] = {'type': "Convolution", 'convolution_param':{'num_output':1000, 'kernel_size':1, 'stride':1, 'weight_filler':{'std':0.01}}}
    barebones_net['relu_cccp8'] = {'type': "ReLU"}

    #TODO: globalpooling here...
...
if __name__ == '__main__':
    ...
    out_net_file = './' + phase +'_NiN_conv1_st1_conv2_st2_conv3_st2.prototxt'
